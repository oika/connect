...
delete_bd_objs [get_bd_intf_nets axis_register_slice_format2logic_M_AXIS] [get_bd_intf_nets window_aggregation_0_resultOut_V_V] [get_bd_intf_nets axis_register_slice_prepare_start_M_AXIS] [get_bd_intf_nets window_aggregation_0_prepare_done_V_V] [get_bd_cells window_aggregation_0]
delete_bd_objs [get_bd_intf_nets axis_register_slice_rx_M_AXIS] [get_bd_intf_nets window_aggregation_format_0_rxEventOut_V_field0_V] [get_bd_intf_nets axis_register_slice_logic2format_M_AXIS] [get_bd_intf_nets window_aggregation_format_0_txDataOut] [get_bd_cells window_aggregation_format_0]
